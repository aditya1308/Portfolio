...
const Contact = () => {
	...
	const handleSubmit = (e) => {
		...
		console.log(EMAIL_JS_PUBLIC_KEY,EMAIL_JS_SERVICE_ID,EMAIL_JS_TEMPLATE_ID);
		...
		emailjs
			.send(
				...
				{
					from_name: username,
					to_name: "Aditya Prasad",
					reply_to: user_email,
					to_email: "adi1308.prasad@gmail.com",
			...
			<div className='text-white contact overflow-x-hidden pt-12 mt-8 ' id='contact'>
				<div className='z-10 w-full sm:w-[650px] m-auto p-8 rounded-2xl' >
					...
					>
						...
						<button
							type='submit'
							className='pt-1 px-8 rounded-xl outline-none w-fit font-bold shadow-md bg-gray-900'
						>
